...
command=$(kdialog  --geometry 300X1200+750+500 --title "New Edge Command " --inputbox "<center><br>Enter your command (or <b>absolute</b> path to a script file)<br></center><i>*notice</i>: <i>Make sure to try your commands before adding them.</i><br><br><br>")
